...
openshift_metrics_hawkular_nodeselector={"router":"public"}
openshift_metrics_cassandra_nodeselector={"router":"public"}
openshift_metrics_heapster_nodeselector={"router":"public"}
...
openshift_logging_es_nodeselector={"router":"public"}
openshift_logging_kibana_nodeselector={"router":"public"}
openshift_logging_curator_nodeselector={"router":"public"}
